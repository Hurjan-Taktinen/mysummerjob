...
class scheduler
{
    ...
    struct continuation
    {
        continuation(process_handler* ref) : handler{ref}
        {
            ENTT_ASSERT(handler);
        }
        ...
        {
            return then<process_adaptor<std::decay_t<Func>, Delta>>(
...
public:
     ...
     */
    [[nodiscard]] bool empty() const ENTT_NOEXCEPT { return handlers.empty(); }
