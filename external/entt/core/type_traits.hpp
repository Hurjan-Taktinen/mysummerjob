 ...
 */
template<typename... Type, typename... Other>
constexpr type_list<Type..., Other...> operator+(
        type_list<Type...>, type_list<Other...>)
{
    return {};
}
...
inline constexpr auto type_list_contains_v =
...
struct type_list_diff<type_list<Type...>, type_list<Other...>>
{
    ...
    using type = type_list_cat_t<std::conditional_t<
            type_list_contains_v<type_list<Other...>, Type>,
            type_list<>,
            type_list<Type>>...>;
};
 ...
 */
template<auto... Value, auto... Other>
constexpr value_list<Value..., Other...> operator+(
        value_list<Value...>, value_list<Other...>)
{
    return {};
}
...
struct value_list_cat<value_list<Value...>, value_list<Other...>, List...>
{
    /*! @brief A value list composed by the values of all the value lists. */
    using type =
            typename value_list_cat<value_list<Value..., Other...>, List...>::
                    type;
};
...
{
    return is_equality_comparable<typename Type::key_type>(choice<2>)
           && is_equality_comparable<typename Type::mapped_type>(choice<2>);
}
...
struct is_equality_comparable :
    std::bool_constant<internal::is_equality_comparable<Type>(choice<2>)>
{
};
 ...
 */
template<class Type>
inline constexpr auto is_equality_comparable_v =
 ...
 */
template<typename Ret, typename Func, typename Args>
inline constexpr auto is_applicable_r_v =
