...
struct is_key_only_meta_associative_container<
        Type,
        std::void_t<typename meta_associative_container_traits<
                Type>::type::mapped_type>> : std::false_type
{
};
 ...
 */
template<typename Type>
inline constexpr auto is_key_only_meta_associative_container_v =
        is_key_only_meta_associative_container<Type>::value;
 ...
 */
template<typename Type>
inline constexpr auto is_meta_pointer_like_v =
