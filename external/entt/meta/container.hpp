...
struct basic_container
{
     ...
     */
    [[nodiscard]] static typename Container::size_type size(
            const Container& cont) ENTT_NOEXCEPT
    {
        return cont.size();
    }
     ...
     * @return An iterator to the first element of the given container.
     */
    [[nodiscard]] static typename Container::const_iterator cbegin(
     ...
     * @return An iterator past the last element of the given container.
     */
    [[nodiscard]] static typename Container::const_iterator cend(
            const Container& cont)
    {
        return cont.end();
    }
...
struct basic_associative_container
{
     ...
     */
    [[nodiscard]] static typename Container::iterator find(
            Container& cont, const typename Container::key_type& key)
    {
        return cont.find(key);
    }

    /*! @copydoc find */
    [[nodiscard]] static typename Container::const_iterator cfind(
            const Container& cont, const typename Container::key_type& key)
    {
        return cont.find(key);
    }
};
...
struct basic_dynamic_associative_container
{
     ...
     */
    [[nodiscard]] static bool erase(
            [[maybe_unused]] Container& cont,
...
struct basic_sequence_container
{
     ...
     */
    [[nodiscard]] static typename Container::reference get(
            Container& cont, typename Container::size_type pos)
    {
        return cont[pos];
    }

    /*! @copydoc get */
    [[nodiscard]] static typename Container::const_reference cget(
            const Container& cont, typename Container::size_type pos)
    {
        return cont[pos];
    }
};
...
struct dynamic_associative_key_value_container
{
    ...
    [[nodiscard]] static bool insert(
            [[maybe_unused]] Container& cont,
            [[maybe_unused]] const typename Container::key_type& key,
            [[maybe_unused]] const typename Container::mapped_type& value)
    {
...
struct dynamic_sequence_container
{
     ...
     */
    [[nodiscard]] static std::pair<typename Container::iterator, bool> insert(
            [[maybe_unused]] Container& cont,
     ...
     * took place.
     */
    [[nodiscard]] static std::pair<typename Container::iterator, bool> erase(
            [[maybe_unused]] Container& cont,
            [[maybe_unused]] typename Container::const_iterator it)
    {
...
struct fixed_sequence_container
{
     ...
     */
    [[nodiscard]] static bool resize(
            const Container&, typename Container::size_type)
    {
        return false;
    }
     ...
     * @return False to indicate failure in all cases.
     */
    [[nodiscard]] static bool clear(const Container&) { return false; }
     ...
     */
    [[nodiscard]] static std::pair<typename Container::iterator, bool> erase(
            const Container&, typename Container::const_iterator)
    {
        return {{}, false};
    }
};
