...
template<typename texture_type, typename gen_type>
void clear_level(
        texture_type& Texture, size_t BaseLevel, gen_type const& BlockData);
...
template<typename texture_type, typename gen_type>
void clear_face(
        texture_type& Texture, size_t BaseFace, gen_type const& BlockData);
...
template<typename texture_type, typename gen_type>
void clear_layer(
        texture_type& Texture, size_t BaseLayer, gen_type const& BlockData);
