            ...
            texel_type>
{
            ...
            texel_type const& BorderColor)
    {
        ...
        normalized_type const TexelLast(
                normalized_type(TexelDim) - normalized_type(1));
            ...
            texel_type>
{
            ...
            texel_type const& BorderColor)
    {
        ...
        extent_type const TexelCoord(
                SampleCoordWrap * TexelLast + interpolate_type(0.5));
            ...
            texel_type>
{
            ...
            texel_type const& BorderColor)
    {
        ...
        if(Coord.UseTexelFloor.s)
            Texel0 =
                    Fetch(Texture,
                          extent_type(Coord.TexelFloor.s),
                          Layer,
                          Face,
                          Level);
            ...
            texel_type>
{
            ...
            texel_type const& BorderColor)
    {
        ...
        texel_type const& Texel00 =
                Fetch(Texture,
                      extent_type(Coord.TexelFloor.s, Coord.TexelFloor.t),
                      Layer,
                      Face,
                      Level);
        texel_type const& Texel10 =
                Fetch(Texture,
                      extent_type(Coord.TexelCeil.s, Coord.TexelFloor.t),
                      Layer,
                      Face,
        ...
        texel_type const MinTexel =
                nearest<Dimension,
                        ...
                        call(Texture,
                             ...
                             Layer,
                             Face,
                             static_cast<size_type>(floor(Level)),
                             BorderColor);
        texel_type const MaxTexel =
                nearest<Dimension,
                        ...
                        call(Texture,
                             ...
                             Layer,
                             Face,
                             static_cast<size_type>(ceil(Level)),
                             BorderColor);
