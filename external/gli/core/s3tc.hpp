...
glm::vec4 decompress_dxt1(
        const dxt1_block& Block, const extent2d& BlockTexelCoord);
texel_block4x4 decompress_dxt1_block(const dxt1_block& Block);

glm::vec4 decompress_dxt3(
        const dxt3_block& Block, const extent2d& BlockTexelCoord);
texel_block4x4 decompress_dxt3_block(const dxt3_block& Block);

glm::vec4 decompress_dxt5(
        const dxt5_block& Block, const extent2d& BlockTexelCoord);
