...
public:
    ...
    texel_type texel_fetch(
            extent_type const& TexelCoord, size_type const& Level) const;
    ...
    texel_type texture_lod(
            normalized_type const& SampleCoord, level_type Level) const;

    /// Sample a texture using specified gradiants
    texel_type texture_grad(
            normalized_type const& SampleCoord,
            normalized_type const& dPdx,
            normalized_type const& dPdy) const;
